...
def func(market_id:str, **kwargs) -> pd.Series:
    """計算並取得指定市場 ID 中的歷史資料, 每個日期是否有發生實體長陽線的序列
...
wj007 = Macro(code=code, name=name, description=description, parameters=params,
