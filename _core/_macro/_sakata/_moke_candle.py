...
class KType(Enum):
    ...
    WHITE_LONG_TINY_UPPER_SHADOW = TCandle.make(name="具有短上影線的大陽線", ud=1, ampt=10.0, body=0.95, t_offset=0.05)
    WHITE_LONG_TINY_LOWER_SHADOW = TCandle.make(name="具有短下影線的大陽線", ud=1, ampt=10.0, body=0.95, t_offset=0.0)
    ...
    WHITE_TINY_SHORT_EQUAL_SHADOW = TCandle.make(name="上下影線都短的極小陽線", ud=1, ampt=10.0, body=0.4, t_offset=0.3)
    WHITE_SHORT_EQUAL_SHADOW = TCandle.make(name="上下影線都短的陽線", ud=1, ampt=10.0, body=0.5, t_offset=0.25)
    BLACK_LONG = TCandle.make(name="大陰線", ud=0, ampt=10.0, body=1.0, t_offset=0.0)
    BLACK_LONG_TINY_UPPER_SHADOW = TCandle.make(name="具有短上影線的大陰線", ud=0, ampt=10.0, body=0.95, t_offset=0.05)
    BLACK_LONG_TINY_LOWER_SHADOW = TCandle.make(name="具有短下影線的大陰線", ud=0, ampt=10.0, body=0.95, t_offset=0.0)
    BLACK_LONG_TINY_EQUAL_SHADOW = TCandle.make(name="上下影線都短的大陰線", ud=0, ampt=10.0, body=0.9, t_offset=0.05)
    ...
    BLACK_TINY_SHORT_EQUAL_SHADOW = TCandle.make(name="上下影線都短的極小陰線", ud=0, ampt=10.0, body=0.4, t_offset=0.3)
    BLACK_SHORT_EQUAL_SHADOW = TCandle.make(name="上下影線都短的陰線", ud=0, ampt=10.0, body=0.5, t_offset=0.25)
