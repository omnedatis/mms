# -*- coding: utf-8 -*-
"""Black Long-Line.
Created on Mon Sep 19 10:42:24 2022
...
_DAY = np.array([[100., 100.5, 97.5, 98.]]).T
_WEEK = np.array([[100., 101, 94., 95.]]).T
_MONTH = np.array([[100., 102., 88., 90.]]).T
...
def _func(cct: Candlestick) -> NumericTimeSeries:
    ret = (cct.is_long_body & cct.is_black_body &
