...
_DAY = np.array([[100., 103., 96., 99.]]).T
_WEEK = np.array([[100., 106., 92., 98.]]).T
_MONTH = np.array([[100., 112., 84., 96.]]).T
...
def _func(cct: Candlestick) -> NumericTimeSeries:
    ret = (cct.is_short_body & cct.is_black_body &
