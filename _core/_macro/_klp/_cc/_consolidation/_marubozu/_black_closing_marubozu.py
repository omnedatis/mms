# -*- coding: utf-8 -*-
"""Common used by Macors in BlackClosingMarubozu's Series.
...
_ENG_NAME = 'BlackClosingMarubozu'
_CHT_NAME = '光腳陰線'
...
_DAY = np.array([[100., 100.5, 98., 98.]]).T
_WEEK = np.array([[100., 101., 95., 95.]]).T
_MONTH = np.array([[100., 102., 90., 90.]]).T
...
def _func(cct: Candlestick) -> NumericTimeSeries:
    ret = cct.is_long_body & cct.is_black_body & cct.is_without_lowershadow
    return ret
