# -*- coding: utf-8 -*-
"""Common used by Macors in WhiteMarubozu's Series.
...
_DAY = np.array([[100., 102., 100., 102.]]).T
_WEEK = np.array([[100., 105., 100., 105.]]).T
_MONTH = np.array([[100., 110., 100., 110.]]).T
