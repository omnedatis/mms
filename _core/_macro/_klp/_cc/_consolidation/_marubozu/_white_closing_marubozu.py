# -*- coding: utf-8 -*-
"""Common used by Macors in WhiteClosingMarubozu's Series.
...
_ENG_NAME = 'WhiteClosingMarubozu'
_CHT_NAME = '光頭陽線'
...
_DAY = np.array([[100., 102., 99.5, 102.]]).T
_WEEK = np.array([[100., 105., 99., 105.]]).T
_MONTH = np.array([[100., 110., 98., 110.]]).T
...
def _func(cct: Candlestick) -> NumericTimeSeries:
    ret = cct.is_long_body & cct.is_white_body & cct.is_without_uppershadow
    return ret
