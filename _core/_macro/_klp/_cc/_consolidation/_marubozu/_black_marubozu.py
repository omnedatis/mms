# -*- coding: utf-8 -*-
"""Common used by Macors in BlackMarubozu's Series.
...
_DAY = np.array([[100., 100., 98., 98.]]).T
_WEEK = np.array([[100., 100., 95., 95.]]).T
_MONTH = np.array([[100., 100., 90., 90.]]).T
