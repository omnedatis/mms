...
class DoutzeCandleStick(_CandleStick):
    ...
    def ignored_amplitude(self, close_zero_threshold: float
        ...
        """
        cache_key  = f'ignored_amplitude({close_zero_threshold}%)'
        if cache_key not in self._cache:
    ...
    def long_body(self, violent_threshold: float) -> BooleanTimeSeries:
        ...
        """
        cache_key  = f'long_body({violent_threshold}%)'
        if cache_key not in self._cache:
    ...
    def short_body(self, violent_threshold: float,
        ...
        """
        cache_key  = f'short_body({violent_threshold}%, {close_zero_threshold}%)'
        if cache_key not in self._cache:
    ...
    def ignored_body(self, close_zero_threshold: float) -> BooleanTimeSeries:
        ...
        """
        cache_key  = f'ignored_body({close_zero_threshold}%)'
        if cache_key not in self._cache:
    ...
    def long_lower_shadow(self, long_shadow_threshold: float
        ...
        """
        cache_key  = f'long_lower_shadow({long_shadow_threshold}%)'
        if cache_key not in self._cache:
    ...
    def short_lower_shadow(self, long_shadow_threshold: float,
        ...
        """
        cache_key  = f'short_lower_shadow({long_shadow_threshold}, {shadow_ignore_threshold})'
        if cache_key not in self._cache:
    ...
    def ignored_lower_shadow(self, shadow_ignore_threshold: float
        ...
        """
        cache_key  = f'ignored_lower_shadow({shadow_ignore_threshold}%)'
        if cache_key not in self._cache:
    ...
    def long_upper_shadow(self, long_shadow_threshold: float
        ...
        """
        cache_key  = f'long_upper_shadow({long_shadow_threshold}%)'
        if cache_key not in self._cache:
    ...
    def short_upper_shadow(self, long_shadow_threshold: float,
        ...
        """
        cache_key  = f'short_upper_shadow({long_shadow_threshold}, {shadow_ignore_threshold})'
        if cache_key not in self._cache:
    ...
    def ignored_upper_shadow(self, shadow_ignore_threshold: float
        ...
        """
        cache_key  = f'ignored_upper_shadow({shadow_ignore_threshold}%)'
        if cache_key not in self._cache:
...
def get_candle(market_id: str, period_type: Union[int, TimeUnit],
               _cache={}) -> _CandleStick:
    ...
    if name not in _cache:
        _cache[name] = DoutzeCandleStick.make(TI.Candle(market_id, period_type))
    return _cache[name]
