# -*- coding: utf-8 -*-
"""
Created on Wed Jun  2 16:12:29 2022
...
def _plotter(**kwargs) -> dict:
    ...
    curve_map = {
        ...
        'ma_mid_period': {'start': 1, 'stop': 1.5},
        'ma_short_period': {'start': 1, 'stop': 1.5}
    }
    for key, value in kwargs.items():
...
jack_ma_order_up = Macro(code='jack_ma_order_up', name='MA由大至小短中長排列', desc=__doc__,
                         params=params, run=_jack_ma_order_up, check=_checker, plot=_plotter,
