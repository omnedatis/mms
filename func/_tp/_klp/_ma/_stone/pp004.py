...
def arg_checker(period_1, period_2, period_3, period_4, period_5,
    ...
    lower = 1
    for idx, value in enumerate([period_1, period_2, period_3, period_4,
...
def sample_generator(period_1, period_2, period_3, period_4, period_5,
                     period_6, period_7, period_8, ridge_index, lookback_len=-1):
...
stone_pp004 = RawMacro(code, name, description, parameters, macro,
