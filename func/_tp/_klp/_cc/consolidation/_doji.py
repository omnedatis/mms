    ...
    'bullish': {
        TimeUnit.DAY:
            np.array([[75.48207395, 77.98480587, 74.80489363, 77.8324632 ],
                      ...
                      [86.31172403, 87.21899214, 85.7440667 , 86.16605868]]).T,
        TimeUnit.WEEK:
            np.array([[ 91.46687815,  92.54620307,  88.47633535,  92.51393525],
                      ...
                      [118.00763804, 121.43075317, 115.31471967, 117.99319273]]).T,
        TimeUnit.MONTH:
            np.array([[ 75.72824464,  88.79213053,  75.11696398,  87.30340966],
                      ...
                      [144.71555368, 149.88426998, 129.57213255, 145.51681529]]).T},
    'bearish': {
        TimeUnit.DAY:
            np.array([[112.04227086, 112.81792123, 110.97659952, 112.81792123],
                      ...
                      [ 99.79624986, 101.93357416,  99.0331805 ,  99.77868963]]).T,
        TimeUnit.WEEK:
        ...
        TimeUnit.MONTH:
            np.array([[36.78761049, 37.51003709, 33.67738947, 36.09139617],
                      ...
                      [22.12560108, 23.81965021, 21.37566654, 22.23895376]]).T}}
