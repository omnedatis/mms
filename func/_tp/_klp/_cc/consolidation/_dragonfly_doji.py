    ...
    'bullish': {
        TimeUnit.DAY:
            np.array([[190.3763738 , 194.55094141, 188.92057307, 191.07844663],
                      ...
                      [217.42689445, 217.77226733, 211.41264905, 217.14390845]]),
        TimeUnit.WEEK:
            np.array([[188.57687584, 210.59712537, 183.64337053, 210.59712537],
                      ...
                      [244.95241964, 246.90363689, 237.02734084, 245.28298313]]),
        TimeUnit.MONTH:
            np.array([[275.17903668, 275.54436687, 234.10685277, 256.19007255],
                      ...
                      [419.30871911, 428.1762607 , 388.5061408 , 424.71341971]])},
    'bearish': {
        TimeUnit.DAY:
            np.array([[90.63529412, 91.81073519, 88.94514661, 91.81073519],
                      ...
                      [83.72804087, 83.84680288, 82.00110789, 83.61066623]]),
        TimeUnit.WEEK:
            np.array([[3166.17571104, 3227.1381957 , 2971.95850341, 2980.465229  ],
                      ...
                      [2757.3324286 , 2769.61571417, 2561.15175904, 2758.17146843]]),
        TimeUnit.MONTH:
            np.array([[354.98396184, 363.61941586, 321.17854737, 351.54863498],
                      ...
                      [269.14879986, 270.38553588, 231.80065172, 269.61736049]])}}
