...
from model import CatchableTread, ModelInfo, PatternInfo
from utils import dict_equals, pickle_dump, pickle_load
...
class MimosaDBCacheManager:
    ...
    def _construct_pattern_info(self,
        ...
        for i in range(len(pattern_info)):
            ...
            results.append(PatternInfo(pattern_id, func_code, params))
        return results
